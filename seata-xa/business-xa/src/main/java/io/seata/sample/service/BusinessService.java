...
//        }
    ...
    public void initData() {
        ...
        jdbcTemplate.update(
            "insert into storage_tbl(commodity_code,count) values('" + TestDatas.COMMODITY_CODE + "','100') ");
    }
    ...
    public boolean validData(String userId, String commodityCode) {
        ...
        Map stockMap = jdbcTemplate.queryForMap("select * from storage_tbl where commodity_code='" + commodityCode + "'");
